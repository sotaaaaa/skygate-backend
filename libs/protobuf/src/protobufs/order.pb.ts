...
export const protobufPackage = "com.skygate.service.order";
...
export const COM_SKYGATE_SERVICE_ORDER_PACKAGE_NAME = "com.skygate.service.order";
...
export interface ServiceOrderController {
  /**
   * HealthCheck là một phương thức RPC đơn lẻ kiểm tra trạng thái sức khỏe của dịch vụ
   * cổng.
   * @param Empty - Một tin nhắn yêu cầu trống.
...
export function ServiceOrderControllerMethods() {
  return function (constructor: Function) {
    const grpcMethods: string[] = ["pingService"];
    for (const method of grpcMethods) {
      const descriptor: any = Reflect.getOwnPropertyDescriptor(constructor.prototype, method);
      GrpcMethod("ServiceOrder", method)(constructor.prototype[method], method, descriptor);
    }
    const grpcStreamMethods: string[] = [];
    for (const method of grpcStreamMethods) {
      const descriptor: any = Reflect.getOwnPropertyDescriptor(constructor.prototype, method);
      GrpcStreamMethod("ServiceOrder", method)(constructor.prototype[method], method, descriptor);
    }
  };
}

export const SERVICE_ORDER_SERVICE_NAME = "ServiceOrder";
