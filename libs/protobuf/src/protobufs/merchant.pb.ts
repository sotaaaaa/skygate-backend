...
export const protobufPackage = "com.skygate.service.merchant";
...
export const COM_SKYGATE_SERVICE_MERCHANT_PACKAGE_NAME = "com.skygate.service.merchant";
...
export interface ServiceMerchantClient {
  /**
...
export interface ServiceMerchantController {
  /**
   * HealthCheck là một phương thức RPC đơn lẻ kiểm tra trạng thái sức khỏe của dịch vụ
   * cổng.
   * @param Empty - Một tin nhắn yêu cầu trống.
...
export function ServiceMerchantControllerMethods() {
  return function (constructor: Function) {
    const grpcMethods: string[] = ["pingService"];
    for (const method of grpcMethods) {
      const descriptor: any = Reflect.getOwnPropertyDescriptor(constructor.prototype, method);
      GrpcMethod("ServiceMerchant", method)(constructor.prototype[method], method, descriptor);
    }
    const grpcStreamMethods: string[] = [];
    for (const method of grpcStreamMethods) {
      const descriptor: any = Reflect.getOwnPropertyDescriptor(constructor.prototype, method);
      GrpcStreamMethod("ServiceMerchant", method)(constructor.prototype[method], method, descriptor);
    }
  };
}

export const SERVICE_MERCHANT_SERVICE_NAME = "ServiceMerchant";
